...
public partial class MainWindow : Window
{
    ...
    private async void BingMap_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
    {
        ...
        LabelSnow.Content = weatherData.Snow != null && weatherData.Snow._3h > 0 ? "Czy pada deszcz tak: Tak" : "Czy pada deszcz nie : Nie";
        LabelRain.Content = weatherData.Rain != null && weatherData.Rain._1h > 0 ? "Czy pada śnieg tak : Tak" : "Czy pada śnieg nie: Nie";
    ...
    private void BingMap_MouseWheel(object sender, MouseWheelEventArgs e)
    {
        ...
        if (bingMap.ZoomLevel >= 2.0 && e.Delta < 0)
        {
            // Pozwól na zoomowanie w głąb, jeśli poziom zoomu jest większy lub równy 2.5
        }
        else if (bingMap.ZoomLevel <= 1.2 && e.Delta > 0)
        {
